	...
	<div>
		...
		<el-card class="register-card" :style="{'background': darkStyle?'rgba(10, 10, 10, 0.7)':'rgba(250, 250, 250, 0.7)'}">
			<div slot="header">
				...
				<span :style="{'color': darkStyle?'white':'dodgerblue'}">山大OJ注册页</span>
			</div>
			<el-form :model="formData" :rules="rules" ref="formData">
				<el-form-item prop="id">
					<el-input class="input" @keydown.enter.native="register" placeholder="请输入账户" prefix-icon="el-icon-user" v-model="formData.id"></el-input>
				</el-form-item>
				...
				<el-form-item>
					<el-button class="btn" @click="sendCaptcha" :disabled="countdown != 60" plain>{{captcha}}</el-button>
