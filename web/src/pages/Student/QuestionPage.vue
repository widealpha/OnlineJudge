		...
		<el-main>
			<el-card>
				<div slot="header" style="text-align: center">
					<span id="back" @click="backToProblems"><i class="el-icon-arrow-left"></i>返回题目列表</span>
					<span style="font-weight: bolder; color: gray">{{title}}</span>
				</div>
				<div>
					<el-col :span="24">
						<div class="questiondetails">
							<question-details :problemId.sync="problemId" :title.sync="title" ref="questionDetails"></question-details>
						</div>
